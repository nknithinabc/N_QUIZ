...
public class Contest extends BaseEntity{
    ...
    public Contest(String name, List<Question> questions, Level level, User creator,
            ContestStatus contestStatus) {
        this.name = name;
        //this.questions = new ArrayList<>();  //ORIG
    ...
    public String toString() {
        return "Contest [id=" + id + ", name=" + name + ", level=" + level + ", creator=" + creator.getName() + ", contestStatus=" + contestStatus + ", questions=" + getQuestions() + "]";
    }
